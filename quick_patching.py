...
def process_wsi(wsi_path,
    ...
    try:
        ...
        for (x, y) in selected:
            ...
            # ----------------------------------------------
            # TODO: SET training_set TO TRUE IF YOU ARE MAKING TRAINING PATCHES
            # ----------------------------------------------
...
if __name__ == "__main__":
    ...
    num_of_words = 1000
    # TODO: provide the path to the training data
    wsi_dir = f'/path/to/training_data'
    # TODO: provide directory to save the training patches too
    save_dir = f'/path/to/save/training_TEST_{patch_size}x{patch_size}_patches'
