...
def leave_one_out_test(histogram_dict, csv_filepath, top_n):
    ...
    with open(csv_filepath, newline='') as csvfile:
        ...
        # Or replace with your filename header
    ...
    for slide_name, hist in histogram_dict.items():
        # SLIDE NAME MUST END WITH .svs to do search
...
if __name__ == "__main__":
    # NOTE: This code below is for testing purpose only 
    # Load the histogram dictionary from the .pkl file
    # TODO: Provide the correct path to the histogram dictionary file
    histogram_path = '/path/to/histogram/dictinary/file.pkl'
    with open(histogram_path, 'rb') as file:
        histogram_dict = pickle.load(file)

    # TODO: Provide the path to your CSV file for the data information
