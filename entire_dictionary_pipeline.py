...
if __name__ == "__main__":
    ...
    # TODO: Change this to your testing data path
    wsi_dir = '/path/to/testing_data'
    
    # TODO: Provide path to your pretrained model on the train set
    model_path = f'/path/to/autoencoder.pth'
    # CSV file path must have 'file_name' and 'label' headers. And the filenames must be in the format "<name>.svs"
    # TODO: Provide path to your csv file
    csv_path = '/path/to/file.csv'
    
    # TODO: Provide the path where you want to save the results
    save_data_path = f'/path/to/result/folder/{cluster_size}_clusters/{model}_{model_name}_{number_words_per_slide}'
